...
module.exports = {
  siteMetadata: {
    ...
    description: `I blog about things I like.`,
    siteUrl: `https://sardonyx001.github.io/`,
    social: {
      twitter: `whyamihere001`,
    },
  },
  plugins: [
    `gatsby-plugin-image`,
    ...
    },
    {
      ...
      options: {
        ...
        // theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/userpic.jpeg`, // This path is relative to the root of the site.
      },
    },
  ],
};
